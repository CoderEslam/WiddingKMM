 ...
 */
class PhotoViewAttacher(imageView: PhotoView) : OnTouchListener,
    ...
    private val onGestureListener: OnGestureListener = object : OnGestureListener {
        override fun onDrag(dx: Float, dy: Float) {
             ...
             */
            val parent: ViewParent = mImageView.getParent()
    ...
    private fun getDisplayRect(matrix: Matrix): RectF? {
        val d: Drawable = mImageView.getDrawable()
        if (d != null) {
    ...
    init {
        ...
        mScaleDragDetector = CustomGestureDetector(imageView.getContext(), onGestureListener)
        mGestureDetector =
            GestureDetector(imageView.getContext(), object : SimpleOnGestureListener() {
