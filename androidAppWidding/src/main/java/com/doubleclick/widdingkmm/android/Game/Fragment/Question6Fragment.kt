...
import com.doubleclick.widdingkmm.android.databinding.FragmentQuestion6Binding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.maze.view.onItemGameChange(object : setOnGame {
            override fun setOnClickGame(stat: Int) {
                lifecycleScope.launch(Dispatchers.Main) {
                    findNavController().navigate(Question6FragmentDirections.actionQuestion6FragmentToQuestion7Fragment())
                }
            }
        })
    }
