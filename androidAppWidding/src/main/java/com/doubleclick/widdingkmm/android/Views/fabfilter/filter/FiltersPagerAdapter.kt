...
import com.doubleclick.widdingkmm.android.Views.fabfilter.utils.bindColor
import com.doubleclick.widdingkmm.android.Views.fabfilter.utils.bindOptionalViews
import com.doubleclick.widdingkmm.android.Views.fabfilter.views.FilterSeekbar
import com.doubleclick.widdingkmm.android.Views.fabfilter.utils.blendColors
import com.doubleclick.widdingkmm.android.Views.fabfilter.utils.getValueAnimator
...
class FiltersPagerAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FiltersPagerViewHolder =
        FiltersPagerViewHolder(LayoutInflater.from(parent.context).inflate(viewType, parent, false))
    ...
    class FiltersPagerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val filterViews: List<ImageView> by bindOptionalViews(
            R.id.filter_pill_1, R.id.filter_pill_2,
            R.id.filter_pill_3, R.id.filter_pill_4, R.id.filter_pill_5, R.id.filter_pill_6
        )

        val seekBars: List<FilterSeekbar> by bindOptionalViews(
            R.id.rangeSeekbar1,
            R.id.rangeSeekbar2
        )
    }
