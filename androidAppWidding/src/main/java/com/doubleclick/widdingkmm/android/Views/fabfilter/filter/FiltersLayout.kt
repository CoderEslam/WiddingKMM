package com.doubleclick.widdingkmm.android.Views.fabfilter.filter
...
import com.doubleclick.widdingkmm.android.Views.fabfilter.filter.ViewPagerTabsHandler
...
import com.doubleclick.widdingkmm.android.Views.fabfilter.utils.*
import com.doubleclick.widdingkmm.android.Views.fabfilter.views.NoScrollRecyclerView
import com.doubleclick.widdingkmm.android.R
import com.doubleclick.widdingkmm.android.ui.home.HomeFragment
...
class FiltersLayout @JvmOverloads constructor(
    ...
    init {
        ...
        fab.setOnClickListener {
            if ((context as HomeActivity).isAdapterFiltered) {
    ...
    private fun openFilterSheet(isOpening: Boolean) {
        ...
        val scaleDownAnimator = (context as HomeActivity).getAdapterScaleDownAnimator(isOpening)
    ...
    private fun onFilterApplied() {
        ...
        closeIconLoadingAnimator.doOnStart {
            ...
            (context as HomeActivity).isAdapterFiltered = true
        }
        ...
        val scaleDownAnimator = (context as HomeActivity).getAdapterScaleDownAnimator(false)
        scaleDownAnimator.duration = pathAnimator.duration
    ...
    private fun unFilterAdapterWithFabAnimation() {
        ...
        val scaleDownAnimator = (context as HomeActivity).getAdapterScaleDownAnimator(true)
        ...
        closeIconLoadingAnimator.doOnStart { (context as HomeActivity).isAdapterFiltered = false }
        ...
        val scaleUpAnimator = (context as HomeActivity).getAdapterScaleDownAnimator(false)
