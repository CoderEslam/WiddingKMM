...
import com.doubleclick.widdingkmm.android.databinding.FragmentQuestion9Binding
...
class Question9Fragment : Fragment() {
    ...
    private lateinit var binding: FragmentQuestion9Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentQuestion9Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.maze.view.onItemGameChange(object : setOnGame {
            override fun setOnClickGame(stat: Int) {
                lifecycleScope.launch(Dispatchers.Main) {
                    findNavController().navigate(Question9FragmentDirections.actionQuestion9FragmentToQuestion10Fragment())
                }
            }
        })
    }
